...
exports.getAllPayments = exports.getPaymentsByIDPago = exports.getPaymentsByIDPerson = exports.getPaymentsByPerson = exports.updatePayment = exports.createPayment = void 0;
...
const createPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield SqlServer_1.default.query(`EXEC sp_gestion_pagos @accion = 'I',
                                   ...
                                   @archivo = :archivo`, {
            replacements: { id_persona, identificacion, comprobante, tipo_pago, fecha_pago, fecha_presentacion, estado, monto, moneda, usuario, observaciones, archivo },
